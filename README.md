...
테크라이브러리 사이트에 등재된 AI 최신 동향 데이터를 다룬 RAG 시스템으로, <br>
기술 보고서(PDF)를 업로드하면 문서 구조(목차·소제목)를 기반으로 섹션별 예상 질문·답변(Q&A)을 자동 생성하는 문서 분석 시스템입니다.
...
* 사용 목적 : 방대한 기술 보고서를 빠르게 이해하고, 목차 기반 Q&A를 통해 학습과 연구, 회의 및 기술 면접 준비를 효율화하는 것
* 
